    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading">Branch Manager</div>
                ...
                <div class="panel-body">
                    ...
                    <h4>Existing Branches</h4>
                      ...
                      <table class="table">
                        ...
                        @foreach($branches as $branch)
                          <tr>
                            <td>{{$branch->name}}</td>
                            <td>{{$branch->address}}, <br> {{$branch->city}}, <br> {{$branch->state}} | {{$branch->zip_code}}</td>
                            <td>{{$branch->phone_no}}</td>
                            <td><a class="btn btn-danger" href="{{ route('deleteBranch', $branch->id) }}">Delete</a></td>
                          </tr>
                        @endforeach
                        </tbody>
                      </table>
                    ...
                    <hr>
                    <h4>Add a Room</h4>
                     <form class="form-horizontal" method="POST" action="{{ route('addBranch') }}">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group{{ $errors->has('zip_code') ? ' has-error' : '' }}">
                            <label for="zip_code" class="col-md-4 control-label">Zip/Postal Code</label>
